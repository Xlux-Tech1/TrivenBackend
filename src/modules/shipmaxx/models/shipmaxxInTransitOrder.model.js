...
const shipmaxxInTransitOrderSchema = new mongoose.Schema({
...
export const ShipmaxxInTransitOrder = mongoose.model('ShipmaxxInTransitOrder', shipmaxxInTransitOrderSchema);
export default ShipmaxxInTransitOrder;
