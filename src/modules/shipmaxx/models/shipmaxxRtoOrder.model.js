...
const shipmaxxRtoOrderSchema = new mongoose.Schema({
...
export const ShipmaxxRtoOrder = mongoose.model('ShipmaxxRtoOrder', shipmaxxRtoOrderSchema);
export default ShipmaxxRtoOrder;
